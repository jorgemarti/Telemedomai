...
public class Imagen implements Serializable
{
    ...
    private void writeObject(java.io.ObjectOutputStream out)
         throws IOException
     {
         ...
         //Después de mandar la descripcion, mandamos el archivo de imagen, 1k a 1k
    ...
    private void readObject(java.io.ObjectInputStream in)
         throws IOException
     {
        ...
        // Después de recibir la descripción pasamos a escribir físicamente el archivo de imagen
